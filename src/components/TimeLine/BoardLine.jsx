  ...
  if (id === 0) {
    return (
      <div className="board-portrait">
        <img src="https://localhost:3000/img/Turret.jpg" alt="turret" />
      </div>
    );
  } else {
    return (
...
function eliteMonsterImage(championId, monsterType, monsterSubType) {
  if (monsterType === 'DRAGON')
    return (
      <div className="board-portrait">
        <img
          src={'https://localhost:3000/img/dragon/' + monsterSubType + '.png'}
          alt="minion"
    ...
    return (
      <div className="board-portrait">
        <img
          src="https://localhost:3000/img/RIFTHERALD.jpg"
          alt="minion"
          style={{ borderColor: championId < 6 ? '#3388ff' : '#ff88aa' }}
        />
      </div>
...
function turretImgage(teamId, buildingType) {
  if (buildingType === 'TOWER_BUILDING') {
    return (
      <div className="board-portrait">
        <img
          src="https://localhost:3000/img/Turret.jpg"
          alt="Turret"
    ...
    return (
      <div className="board-portrait">
        <img
          src="https://localhost:3000/img/Inhibitor.png"
          alt="Inhibitor"
          style={{ borderColor: teamId === 100 ? '#3388ff' : '#ff88aa' }}
        />
      </div>
